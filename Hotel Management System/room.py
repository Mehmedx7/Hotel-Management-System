...
class Roombooking:
    def __init__(self, root):
        ...
        #===========================fetch data button==================================
        btnFetchData = Button(labelframeleft, command=self.Fetch_contact, text="Fetch Data", font=("arial", 10, "bold"), bg="black", fg="gold", width=8, cursor="hand2")
        ...
        txtcheck = ttk.Entry(labelframeleft, textvariable=self.var_checkin, width=29, font=("arial", 12))
        txtcheck.grid(row=1, column=1)

        # Check out Date
        lblCheck_out = Label(labelframeleft, text="Check-out Date:", font=("arial", 12, "bold"), padx=2, pady=6)
        lblCheck_out.grid(row=2, column=0, sticky=W)
        txt_Check_out = ttk.Entry(labelframeleft, textvariable=self.var_checkout, width=29, font=("arial", 12))
        txt_Check_out.grid(row=2, column=1)

        # Room type
        label_Room = Label(labelframeleft, text="Room Type:", font=("arial", 12, "bold"), padx=2, pady=6)
        ...
        # Available Room
        lblRoomAvailabel = Label(labelframeleft, text="Available Room:", font=("arial", 12, "bold"), padx=2, pady=6)
        lblRoomAvailabel.grid(row=4, column=0, sticky=W)
        ...
        #txtRoomAvailabel = ttk.Entry(labelframeleft, textvariable=self.var_roomavailable, width=29, font=("arial", 12))
        #txtRoomAvailabel.grid(row=4, column=1)

        # Meal
        lblMeal = Label(labelframeleft, text="Meal:", font=("arial", 12, "bold"), padx=2, pady=6)
        lblMeal.grid(row=5, column=0, sticky=W)

        combo_RoomType = ttk.Combobox(labelframeleft, textvariable=self.var_meal, font=("arial", 12), width=27, state="readonly")
        combo_RoomType["value"] = ("BreakFast", "Lunch", "Dinner")
        combo_RoomType.current(0)
        combo_RoomType.grid(row=5, column=1)
        #txtMeal = ttk.Entry(labelframeleft, textvariable=self.var_meal, width=29, font=("arial", 12))
        ...
        txtIdNumber = ttk.Entry(labelframeleft, textvariable=self.var_total, width=29, font=("arial", 12))
        txtIdNumber.grid(row=9, column=1)

        #================Bill Button=========================================
        btnBill = Button(labelframeleft, text="Bill", command=self.total, font=("arial", 11, "bold"), bg="black", fg="gold", width=10, cursor="hand2")
        ...
        #========================right side image======================
        img3 = Image.open(r"D:\images\bed.jpg")
        img3 = img3.resize((530, 225), Image.ANTIALIAS)
        self.photoimg3 = ImageTk.PhotoImage(img3)
        lblimg = Label(self.root, image=self.photoimg3, bd=0, relief=RIDGE)
        lblimg.place(x=800, y=60, width=490, height=225)
        ...
        Tabel_Frame.place(x=435, y=280, width=860, height=220)
        ...
        Details_Tabel.place(x=0, y=50, width=860, height=156)

        scroll_x = ttk.Scrollbar(Details_Tabel, orient=HORIZONTAL)
        scroll_y = ttk.Scrollbar(Details_Tabel, orient=VERTICAL)

        self.room_table = ttk.Treeview(Details_Tabel, columns=("contact", "checkinDate", "checkoutDate", "roomtype", "roomavailable", "meal", "noOfdays",), xscrollcommand=scroll_x.set, yscrollcommand=scroll_y.set)
    ...
    def add_data(self):
        if self.var_contact.get() == "" or self.var_checkin.get() == "":
            ...
            try:
                ...
                messagebox.showwarning("Warning", "Room has already booked try another one", parent=self.root)
    ...
    def Fetch_contact(self):
        if self.var_contact.get()=="":
            ...
            if row==None:
                ...
                showDataframe.place(x=438, y=58, width=350, height=223)
                ...
                lblIdnumber.place(x=0, y=180)
                lbl5 = Label(showDataframe, text=row, font=("arial", 12,))
                lbl5.place(x=100, y=180)
